                  ...
                  <table cellpadding="0" cellspacing="0" class="tblList">
                     <c:forEach items="${listSkills}" var="skill">
                        <tr>
                           ...
                           <td style="width: 10%;" class="tblDefCenter"><a data-toggle="modal" data-target="#exampleModalCenter" onclick="skillId = '${skill.id}'" class="btn btn-danger btn-sm" role="button"><i class="fas fa-trash"></i></a></td>
                        </tr>
                     </c:forEach>
                  </table>
               </table>
         ...
         <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-danger" onclick="window.location.href='/skills/delete/'+skillId">Delete</button>
               </div>
            </div>
         </div>
